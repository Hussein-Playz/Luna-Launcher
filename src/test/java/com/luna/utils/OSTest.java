...
public class OSTest {
    ...
    public void testThatDownloadedRuntimeJavaIsPreferredOverAllOthers() {
        ...
        installedJavas.add(new JavaInfo("C:/luna/runtimes/8.15/64bit/bin/java.exe",
                "C:/luna/runtimes/8.15/64bit", "8.15", 8, 15, true, true));
        assertEquals("C:/luna/runtimes/8.15/64bit", OS.getPreferredJavaPath(installedJavas));
    }
