 ...
 */
package com.luna.data.minecraft.loaders.forge;
...
import com.luna.graphql.GetForgeLoaderVersionsForMinecraftVersionQuery;
...
import com.luna.workers.InstanceInstaller;
...
public class ForgeLoader implements Loader {
    ...
    public static List<LoaderVersion> getChoosableVersions(String minecraft) {
        java.lang.reflect.Type type = new TypeToken<APIResponse<List<lunaApiForgeVersion>>>() {
        }.getType();
        ...
        try {
            if (ConfigManager.getConfigItem("useGraphql.loaderVersions", false) == true) {
                ...
                APIResponse<List<lunaApiForgeVersion>> data = Download.build()
