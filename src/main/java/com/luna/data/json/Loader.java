...
public class Loader {
    ...
    public com.luna.data.minecraft.loaders.Loader getLoader(File tempDir, InstanceInstaller instanceInstaller,
            LoaderVersion loaderVersion) throws Exception {
        com.luna.data.minecraft.loaders.Loader instance = (com.luna.data.minecraft.loaders.Loader) Class
                .forName(this.className.replace("com.luna.data.loaders", "com.luna.data.minecraft.loaders"))
    ...
    public List<LoaderVersion> getChoosableVersions(String minecraft) {
        try {
            Method method = Class
                    .forName(this.chooseClassName.replace("com.luna.data.loaders",
                            "com.luna.data.minecraft.loaders"))
