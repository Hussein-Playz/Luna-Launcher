...
import com.luna.gui.dialogs.CurseForgeProjectFileSelectorDialog;
import com.luna.gui.dialogs.ModrinthVersionSelectorDialog;
...
public class DisableableMod implements Serializable {
    ...
    public static DisableableMod generateMod(File file, com.luna.data.Type type, boolean enabled) {
