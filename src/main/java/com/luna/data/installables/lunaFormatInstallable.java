...
public abstract class lunaFormatInstallable extends Installable {
    public Pack pack;
    public PackVersion packVersion;
    public LoaderVersion loaderVersion;

    public lunaFormatInstallable() {
        this(null, null, null);
    }

    public lunaFormatInstallable(Pack pack, PackVersion packVersion, LoaderVersion loaderVersion) {
        this.pack = pack;
