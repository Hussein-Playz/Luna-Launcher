 ...
 */
package com.luna.network.analytics;
...
import com.luna.data.modrinth.ModrinthSearchHit;
import com.luna.data.modrinth.ModrinthVersion;
import com.luna.data.technic.TechnicModpackSlim;
import com.luna.graphql.fragment.UnifiedModPackResultsFragment;
...
public class AnalyticsEvent {
    ...
    public static AnalyticsEvent forPackInstall(Pack pack, boolean server) {
        return AnalyticsEvent.forPackInstall(pack.name, "luna", server);
    }
