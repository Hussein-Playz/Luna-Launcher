...
public class Constants {
    ...
    public static final String LAUNCHER_NAME = "Luna Launcher";
    public static final String LAUNCHER_WEBSITE = "https://luna.com";
    public static final String DEFAULT_THEME_CLASS = "com.luna.themes.LunaTheme";
    public static final String DISCORD_CLIENT_ID = "589393213723246592";
    public static final String GA_TRACKING_ID = "UA-88820616-7";
    public static final String CROWDIN_URL = "https://crowdin.com/project/luna";
    ...
    public static String BASE_LAUNCHER_DOMAIN = "luna.com";
    ...
    // own
    public static final String MIXPANEL_PROJECT_TOKEN = "72034a40d066857c03255e78abb597d6";
    ...
    // Custom for luna Microsoft login constants
