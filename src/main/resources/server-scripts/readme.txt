...
For a visual guide on how to run servers, please visit our wiki at https://wiki.luna.com/getting-started/starting-a-server/

You can run this server in 2 ways.

The recommended way is to use luna's built in server launcher. This will launch the server with the correct Java version required for this server.
...
Visual guide available at https://wiki.luna.com/guides/changing-servers-memory/
...
Visual guide available at https://wiki.luna.com/guides/changing-servers-java-version/

If you're not running the server through luna, you can change the Java version used to launch the server by editing the LaunchServer.bat/sh file and changing the line near the top.
...
Visual guide available at https://wiki.luna.com/guides/changing-servers-jvm-arguments/
